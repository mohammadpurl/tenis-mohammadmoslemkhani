...
export const translations = {
  en: {
    ...
    cta: { title: "Train Like a Modern Tennis Athlete", sub: "Free assessment. Direct line to the coach.", btn: "WhatsApp Consultation", btn2: "Book Private Session" },
  ...
  fa: {
    ...
    cta: { title: "مثل ورزشکار مدرن تنیس تمرین کن", sub: "ارزیابی رایگان. ارتباط مستقیم با مربی.", btn: "مشاوره واتساپ", btn2: "رزرو جلسه خصوصی" },
  ...
  ar: {
    ...
    cta: { title: "تدرّب كرياضي تنس عصري", sub: "تقييم مجاني. خط مباشر مع المدرب.", btn: "استشارة واتساب", btn2: "احجز جلسة خاصة" },
